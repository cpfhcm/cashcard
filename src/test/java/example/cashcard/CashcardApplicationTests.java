...
class CashcardApplicationTests {
    ...
    void shouldUpdateAnExistingCashCard() {
        ...
        ResponseEntity<String> getReponse = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards/99", String.class);
    ...
    void shouldNotAllowedDeletionOfCashCardsTheyDoNotOwn() {
        ResponseEntity<Void> deleteReponse = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .exchange("/cashcards/102", HttpMethod.DELETE, null, Void.class);
        assertThat(deleteReponse.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
